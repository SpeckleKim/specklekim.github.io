...
Multimodal [large language models](/llm-eng.html) extend the capabilities of text-only systems by processing images, video, audio, and other modalities alongside text. This integration enables richer understanding and more natural human-AI interaction.
...
- Enabling visual [question answering](/question-answering-eng.html)
...
**Architecture**:
- **Image encoder**: [Vision Transformer](/vision-transformers-eng.html) or [CNN](/cnn-deep-dive-eng.html) converts images to embeddings
- **Text encoder**: [Transformer](/llm-eng.html) converts text descriptions to embeddings
...
CLIP's strength is [unsupervised learning](/unsupervised-learning-eng.html) from internet-scale image-text data, avoiding expensive manual labeling.
...
**Architecture**:
- **Visual encoder**: CLIP's [vision transformer](/vision-transformers-eng.html) encodes images
- **Connector**: Simple linear projection bridges vision and language modalities
- **Language model**: LLaMA or other [LLM](/llm-eng.html) generates responses
...
**Performance**: LLaVA achieves impressive visual understanding with relatively simple architecture, showing that good image encoding + [instruction tuning](/instruction-tuning-eng.html) is effective.

## GPT-4V: Sophisticated Vision Understanding

[GPT](/gpt-eng.html)-4V (GPT-4 with vision) represents advanced multimodal capability:

**Capabilities**:
- Fine-grained visual understanding of complex images
- Recognition of text within images ([OCR](/ocr-eng.html))
- Understanding of diagrams, charts, and complex visual layouts
- Reasoning about spatial relationships and object interactions

**Technical approach**: [GPT](/gpt-eng.html)-4V combines powerful text understanding with sophisticated vision processing, likely using multiple vision encoders and architectural innovations beyond simple CLIP-style learning.
...
**Patch-based encoding** ([Vision Transformer](/vision-transformers-eng.html)):
...
- Use [attention mechanisms](/attention-mechanism-eng.html) to focus on relevant regions
...
- [Context window](/context-window-eng.html) usage: Images consume significant token budget
...
- [Hallucination](/hallucination-eng.html) is common (generating plausible but incorrect visual details)

## Emerging Capabilities and Limitations

**Current strengths**:
- Object and scene recognition
- Text recognition in images ([OCR](/ocr-eng.html))
- Spatial reasoning
...
Multimodal [LLMs](/llm-eng.html) represent a significant advancement in AI capability. By combining text and visual understanding, they enable more natural interaction and tackle problems impossible for text-only systems to address.
